...
public class PlayToggleController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        this.toggle.isOn = !this.editManager.IsDropPaused;
    ...
    public void SetIsPlaying(bool flag)
    {
        this.editManager.IsDropPaused = !flag;
    ...
    {
        var flag = !this.editManager.IsDropPaused;
